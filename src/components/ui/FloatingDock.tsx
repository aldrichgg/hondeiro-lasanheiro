...
const FloatingDockDesktop = ({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "mx-auto hidden h-16 items-end gap-4 rounded-2xl bg-slate-900/80 backdrop-blur-sm px-4 pb-3 md:flex border border-slate-800 shadow-xl",
                className,
            )}
        >
            {items.map((item) => (
    ...
    return (
        <Link to={href}>
            <motion.div
                ...
                className="relative flex aspect-square items-center justify-center rounded-full bg-slate-800 border border-slate-700 hover:bg-slate-700 transition-colors"
            >
                <AnimatePresence>
                    {hovered && (
                        <motion.div
                            ...
                            className="absolute -top-8 left-1/2 w-fit rounded-md border border-slate-700 bg-slate-900 px-2 py-0.5 text-xs whitespace-pre text-white shadow-lg"
                        >
                            {title}
                        </motion.div>
                    )}
